ALTER TABLE public.serasa_negativations ADD COLUMN IF NOT EXISTS baixado_aqui boolean DEFAULT false;

DROP FUNCTION IF EXISTS public.get_serasa_cross_reference(text, boolean, date, date, numeric, numeric, integer, integer);
